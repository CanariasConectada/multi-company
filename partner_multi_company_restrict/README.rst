...
colleague, even one from a different company -- or an administrator
account they have no business seeing.
...
Administrators (``base.group_system``) are unaffected and keep seeing
